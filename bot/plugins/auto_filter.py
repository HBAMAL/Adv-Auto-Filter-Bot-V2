    ...
    if len(results) == 0: # double check
        ...
        try:
            await bot.send_photo(
                ...
                caption=f"💬 Requested Query :- <code>{query}</code> 📁 Total Files Found :- {(len_results)} 👉 <a href='https://t.me/joinchat/UZzc1UhZLUnvorhW'> ⚠️ERROR JOIN THIS CHANNEL FIRST⚠️</a>",
